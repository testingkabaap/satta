...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?php echo site_url(ADMIN_SLUG) ?>" class="nav-link">Home</a>
    </li>
  </ul>
...
<!-- BEGIN:: Modal -->
<div class="modal fade" id="viewDataModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="viewDataModalLabel" aria-hidden="true">
